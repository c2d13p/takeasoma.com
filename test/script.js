const TimeTracker = {
  elements: {
    ...
    timeBiggerDisplay: document.querySelector(".time-bigger"),
  },
  ...
  updateTimeDisplay(birthDatetime, mode) {
    ...
    this.elements.timeBiggerDisplay.innerHTML = `<span class="time-bigger">${diff.toLocaleString()} ${
